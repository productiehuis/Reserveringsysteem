    ...
    if ($row->date > $currentDate)
    {
        echo "
            <div class=\"card col-3\">
                <img src=\"/reserveringsysteem/public/img/placeholder.png\" class=\"rounded mt-2 card-img-top\" alt=\"picture\">
                <div class=\"card-body\">
                    ...
                    <p class=\"card-text\"><small class=\"text-muted\">Datum: $convertDate $row->starttime</small></p>
